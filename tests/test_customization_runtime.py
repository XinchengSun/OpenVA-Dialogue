...
class CustomizationRuntimeTests(unittest.TestCase):
    def test_product_pages_use_current_names_and_switch_flow(self):
        ...
        self.assertIn("<title>OpenVA-Dialogue · 实时数字人</title>", realtime)
        self.assertIn('<div class="eyebrow">OpenVA-Dialogue</div>', realtime)
        self.assertNotIn("<title>FlashAV2AV", realtime)
