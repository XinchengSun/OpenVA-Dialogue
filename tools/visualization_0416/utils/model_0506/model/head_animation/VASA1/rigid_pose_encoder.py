...
from model.head_animation.VASA1.hopenet import euler_to_rotation_matrix, headposeprediction_to_euler
...
class RigidPoseEncoder(nn.Module):
    def __init__(self, use_gt_rotation, gt_rotation_callback):
        ...
        if use_gt_rotation:
            ...
            self.net = Resnet18(input_dim=3, output_dim=3)  # 3D translation.
        else:
            self.net = Resnet18(input_dim=3, output_dim=6 + 3)  # 6D rotation and 3D translation.
