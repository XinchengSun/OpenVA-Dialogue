...
def apply_sp_to_nets(obj):
    ...
    spn_networks='app_encoder, idt_encoder, expression_encoder, decoder, warp_embed_head_orig_nw, src2ref, ref2tgt, volume_source_nw, volume_process_nw'
    spn_nets_names = args_utils.parse_str_to_list(spn_networks, sep=',')
