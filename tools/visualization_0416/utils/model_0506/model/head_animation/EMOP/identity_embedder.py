...
import itertools
# import apex
from .utils import replace_bn_to_gn
...
class IdtEmbed(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        if self.cfg.norm_layer_type=='bn':
            ...
            self.net = replace_bn_to_in(self.net, 'IdtEmbed')
        elif self.cfg.norm_layer_type=='gn':
            self.net = replace_bn_to_gn(self.net, 'IdtEmbed')
        elif self.cfg.norm_layer_type == 'bcn':
            self.net = replace_bn_to_bcn(self.net, 'IdtEmbed')
        else:
